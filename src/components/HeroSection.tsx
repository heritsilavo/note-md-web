  ...
  return (
    <section className="bg-blue-50 rounded-xl p-10 flex flex-col md:flex-row items-center gap-8">
      <div className="flex-1">
        ...
        <Link href="https://github.com/heritsilavo/notes-md/releases/latest/download/app-uat-release.apk" target='_blank' className="cursor-pointer bg-blue-900 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-800 transition-colors">
