...
export class NoteDto {
  supabase_id: string; // ID de Supabase
  id: string; // ID local WatermelonDB
  nom_note: string;
  contenu_note: string;
  ...
  constructor(params: {
    ...
    this.date_creation = params.date_creation;
    this.date_heure_note = params.date_heure_note;
    this.date_sync = params.date_sync;
    this.categorie = params.categorie;
    this.typenote = params.typenote;
    this.visible_pour_date_seulement = params.visible_pour_date_seulement;
    this.rappel = params.rappel;
    this.synced = params.synced;
